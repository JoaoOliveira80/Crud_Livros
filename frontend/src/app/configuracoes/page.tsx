      ...
      <main className="max-w-4xl mx-auto px-6 py-16">
        <header className="mb-12">
          ...
          <p className="text-on-surface-60 mt-3 text-lg italic">
            Personalize sua experiência e visualize suas estatísticas.
          </p>
        </header>
          ...
          <section className="bg-surface-container-low p-8 rounded-2xl shadow-sm border border-outline-variant-10">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="bg-surface-container-lowest p-4 rounded-xl border border-outline-variant/5">
                ...
                <p className="text-3xl font-serif text-secondary mt-1">
                  {stats.lidos}
                </p>
              </div>
              <div className="bg-surface-container-lowest p-4 rounded-xl border border-outline-variant/5">
              ...
              <div className="bg-surface-container-lowest p-4 rounded-xl border border-outline-variant/5">
                ...
                <p className="text-3xl font-serif text-on-surface-60 mt-1">
                  {stats.queroLer}
                </p>
              </div>
            </div>
